...
export const chirps = pgTable("chirps", {
  ...
  //foreign key to users - id while having on delete cascade (if user disappears, all associated chirps disappears)
...
export type NewRToken = typeof refreshTokens.$inferInsert;